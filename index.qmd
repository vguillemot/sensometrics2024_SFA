...
The datasets that we will use during the tutorial are detailed [on this page](pages/data.qmd). You can download the datasets with the links below, or the links on the dataset page, or the links at the beginning of each "part" of the tutorial:
